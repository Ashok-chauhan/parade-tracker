<div  align="center"> Edit Front of Parade Route
	...
	echo form_open('home/editlocation');
    echo '<tr>';
	echo '<td>'.form_label('Front of Parade Route name','Front of Parade Route name').'</td>';
	...
	echo '<td></td><td><button id="create-parade">Edit Front of Parade route</button></td>';
	echo '</tr>';
